...
.then((json: MatchesRequestData) => updateSuggestions([sun.value, moon.value, rising.value]))
...
//  updated before calling postAndUpdate().
    document!.addEventListener('keyup', (event) => updateValues(sun.value, moon.value, rising.value));
}
